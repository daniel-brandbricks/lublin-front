  ...
  <b-row>
    <b-col>
      ...
      <b-form-group class="my-3">
        <b-form-radio class="d-inline-block mr-4" v-model="selectedRadio" name="some-radios" value="A">Zajęcia</b-form-radio>
        <b-form-radio class="d-inline-block mr-4" v-model="selectedRadio" name="some-radios" value="B">Frekwencje</b-form-radio>

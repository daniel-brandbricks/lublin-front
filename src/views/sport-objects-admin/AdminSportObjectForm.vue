...
<script>
  ...
  import FormMainData from '@/views/sport-objects-admin/components/FormMainData'
  ...
  export default {
    ...
    methods: {
      ...
      submit () {
        ...
        const method = this.id === undefined ? 'postAdminSportObject' : 'putAdminSportObject'
    ...
    created () {
      ...
      // init sport object
      this.sportObject = Object.assign(this.sportObject, this.$store.getters.adminSportObject(this.isConfirmed, this.id))

      // auto redirect if url is without 'tab' param
      if (this.$route.params.tab === undefined) {
        this.$router.push({ name: 'admin.sport.object', params: { 'tab': 'main-data' } })
      }
      ...
      if (this.id) {
        this.$store.dispatch('getAdminSportObject', { id: this.id })
          .then((response) => {
